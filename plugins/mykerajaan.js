...
if (!('created' in user)) return m.reply('anda tidak memiliki pedesaan')
...
⚔️To tawuran :v typing:
${usedPrefix}attack @mention <jumlah peleton>

🏰Bangun Dan level up desamu :v
...
conn.sendFile( m.chat, imgk, 'kerajaan.jpg', caption, m)
}

handler.help = ['desa', 'desaku']
handler.tags = ['rpg']
handler.command = /^(desa|desaku)/i
