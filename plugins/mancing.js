       ...
       let type = (args[0] || '').toLowerCase()
        switch (type) {
	          case 'easy':
                                  ...
                                  if (pancing == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
                                  if (new Date - global.db.data.users[m.sender].lastfishing > 7200000) {
                                  if (global.db.data.users[m.sender].pancing > 1) {
...
`.trim()
	          ...
	          case 'normal':
                                  ...
                                  let _timerl = (14400000 - __timerl)
                                  let timerl = clockString(_timerl) 
                                  if (pancing == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
                                  if (new Date - global.db.data.users[m.sender].lastfishing > 14400000) {
                                  if (global.db.data.users[m.sender].pancing > 2) {
                                  if (global.db.data.users[m.sender].umpan > 149) {
                                  let randomakud1 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud2 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud3 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud4 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud5 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud6 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud7 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud8 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud9 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud10 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud11 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud12 = `${Math.floor(Math.random() * 20)}`
                                  let randomakud13 = `${Math.floor(Math.random() * 80)}`
...
`.trim()
	          ...
	          case 'hard':
                                  ...
                                  if (pancing == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
                                  if (new Date - global.db.data.users[m.sender].lastfishing > 28800000) {
                                  if (global.db.data.users[m.sender].pancing > 3) {
                                  if (global.db.data.users[m.sender].umpan > 1999) {
                                  ...
                                  let randomakur13 = `${Math.floor(Math.random() * 500)}`
...
`.trim()
                                ...
                                m.reply('Menunggu')
                                 ...
                                 user.lastfishing = new Date * 1
                                 } else conn.reply(m.chat, 'Minimal umpan kamu *2000* untuk memancing level hard', m)
	          ...
	          case 'extreme':
                                  ...
                                  let _timere = (57600000 - __timere)
                                  let timere = clockString(_timere) 
                                  if (pancing == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
                                  if (new Date - global.db.data.users[m.sender].lastfishing > 57600000) {
                                  if (global.db.data.users[m.sender].pancing > 4) {
                                  if (global.db.data.users[m.sender].umpan > 5000) {
                                  ...
                                  let randomakue13 = `${Math.floor(Math.random() * 1000)}`
...
`.trim()
                                ...
                                m.reply('Menunggu')
                                 ...
                                 user.lastfishing = new Date * 1
                                 } else conn.reply(m.chat, 'Minimal umpan kamu *5000* untuk memancing level extreme', m)
...
handler.tags = ['rpg']
handler.command = /^(pancing|mancing)$/i
