...
let handler = async (m, { conn, usedPrefix, DevMode }) => { 
    try { 
        ...
        if (global.db.data.users[m.sender].healt > 79) {
            ...
            let str = `
♥️Nyawa mu berkurang -${healt * 1} karena Kamu telah berpetualang sampai ${pickRandom(['🌁Jakarta', '🏯Jawa', '🏝️Bali', '⚧️Bogor', '🥷Yogyakarta', '🌄Sulawesi', '🗻Kalimantan', '🛖Papua', ' Sabang ke Merauke', '💭Ke bawa dunia mimpi', '🔚Ujung dunia', 'Mars', '🌑Bulan', 'Pluto', '☀️Matahari', '❣️Hatinya dia', '...'])} dan mendapatkan
*✨exp:* ${exp} 
*💹uang:* ${uang}
*🪵Kayu:* ${kayu}
*🕸️ String:* ${string}
