...
let handler = async (m, { conn, args, usedPrefix, DevMode }) => {
    if (args.length < 3) {
        ...
        let count = args[1] && args[1].length > 0 ? Math.min(9999999999999999999999, Math.max(parseInt(args[1]), 1)) : Math.min(1)
            ...
            case 'voucher':
                if (global.db.data.users[m.sender].voucher >= count * 1) {
                    try {
                        ...
                        global.db.data.users[who].voucher += count * 1
                        conn.reply(m.chat, `Berhasil mentransfer ${count} voucher`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].voucher += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                case 'superior':
                    if (global.db.data.users[m.sender].superior >= count * 1) {
                        try {
                            ...
                            conn.reply(m.chat, `Berhasil mentransfer ${count} Superior crate`.trim(), m)
                        } catch (e) {
                            global.db.data.users[m.sender].superior += count * 1
                            m.reply('Gagal Menstransfer')
                            console.log(e)
                    ...
                    } else conn.reply(m.chat, `Superior crate kamu kamu tidak cukup`.trim(), m)
                    break
                    case 'ancient':
                        if (global.db.data.users[m.sender].ancient >= count * 1) {
                            try {
                                ...
                                conn.reply(m.chat, `Berhasil mentransfer ${count} ancient crate`.trim(), m)
                            } catch (e) {
                                global.db.data.users[m.sender].ancient += count * 1
                                m.reply('Gagal Menstransfer')
                                console.log(e)
                        ...
                        } else conn.reply(m.chat, `Ancient crate kamu kamu tidak cukup`.trim(), m)
                        break
                 case 'superancient':
                            if (global.db.data.users[m.sender].superancient >= count * 1) {
                                try {
                                    ...
                                    conn.reply(m.chat, `Berhasil mentransfer ${count} superancient crate`.trim(), m)
                                } catch (e) {
                                    global.db.data.users[m.sender].superancient += count * 1
                                    m.reply('Gagal Menstransfer')
                                    console.log(e)
                            ...
                            } else conn.reply(m.chat, `Superancient crate kamu kamu tidak cukup`.trim(), m)
                            break
            case 'string':
                ...
                case 'ruby':
                    if (global.db.data.users[m.sender].ruby >= count * 1) {
                        try {
                            ...
                            conn.reply(m.chat, `Berhasil mentransfer ruby sebesar ${count}`.trim(), m)
                        } catch (e) {
                            global.db.data.users[m.sender].ruby += count * 1
                            m.reply('Gagal Menstransfer')
                            console.log(e)
                    ...
                    } else conn.reply(m.chat, `Uang kamu tidak mencukupi untuk mentransfer ruby sebesar ${count}`.trim(), m)
                    break 
                    case 'zamrud':
                        if (global.db.data.users[m.sender].zamrud >= count * 1) {
                            try {
                                ...
                                conn.reply(m.chat, `Berhasil mentransfer zamrud sebesar ${count}`.trim(), m)
                            } catch (e) {
                                global.db.data.users[m.sender].zamrud += count * 1
                                m.reply('Gagal Menstransfer')
                                console.log(e)
                        ...
                        } else conn.reply(m.chat, `Uang kamu tidak mencukupi untuk mentransfer zamrud sebesar ${count}`.trim(), m)
                        break 
                        case 'sapphire':
                            if (global.db.data.users[m.sender].sapphire >= count * 1) {
                                try {
                                    ...
                                    conn.reply(m.chat, `Berhasil mentransfer sapphire sebesar ${count}`.trim(), m)
                                } catch (e) {
                                    global.db.data.users[m.sender].sapphire += count * 1
                                    m.reply('Gagal Menstransfer')
                                    console.log(e)
                            ...
                            } else conn.reply(m.chat, `Uang kamu tidak mencukupi untuk mentransfer sapphire sebesar ${count}`.trim(), m)
                            break
                            case 'exp':
                            ...
                            } else conn.reply(m.chat, `Uang kamu tidak mencukupi untuk mentransfer exp sebesar ${count}`.trim(), m)
                            break         
            case 'batu':
