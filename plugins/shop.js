...
const potion = 500
const Barloji = 350000
const Svoucher = 1000
const Bvoucher = 500000
const Ssapphire = 34
const Bsapphire = 1570
const Sruby = 27400000
const Bruby = 76800000
const Szamrud = 55600000
const Bzamrud = 56
...
const Bkuda = 7
const Bfox = 1000
const Bserigala = 10000
const Bphonix = 200000
const Bcentaur = 3500000
const Bgriffin = 35000000
const Bnaga = 987000000
const Bfood = 500
const Bpet = 1500
const Spet = 750
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) => {
    ...
    const pancing = (_pancing == 0 ? 100000 : '' || _pancing == 1 ? 3000000 : '' || _pancing == 2 ? 8500000 : '' || _pancing == 3 ? 16050000 : '' || _pancing == 4 ? 327000000 : '')
    const uppancing = (_pancing == 0 ? 0 : '' || _pancing == 1 ? 2500 : '' || _pancing == 2 ? 8000 : '' || _pancing == 3 ? 17500 : '' || _pancing == 4 ? 127000 : '')
    const durfishingrod = (_pancing == 0 ? 0 : '' || _pancing == 1 ? 50 : '' || _pancing == 2 ? 70 : '' || _pancing == 3 ? 100 : '' || _pancing == 4 ? 100 : '')
    const refishingrod = (_pancing == 0 ? 0 : '' || _pancing == 1 ? 10 : '' || _pancing == 2 ? 35 : '' || _pancing == 3 ? 65 : '' || _pancing == 4 ? 100 : '')
    const drefishingrod = (_pancing == 0 ? 0 : '' || _pancing == 1 ? 10 : '' || _pancing == 2 ? 25 : '' || _pancing == 3 ? 40 : '' || _pancing == 4 ? 60 : '')
    ...
    const uppickaxe = (_pickaxe == 0 ? 0 : '' || _pickaxe == 1 ? 2500 : '' || _pickaxe == 2 ? 5500 : '' || _pickaxe == 3 ? 75000 : '' || _pickaxe == 4 ? 120000 : '')
...
*♻ Barang   | 💲 Harga beli*
━━━━━━━━━━━━━━━━━━━
*🎟 Limit:* 20000 cnth .bely 1
*🎟 voucher:* ${Bvoucher} (Random Limit)
*🥤 Potion:* ${potion}
*🍶 Aqua:* ${Baqua}
*🧭 Arloji:* ${Barloji}
*⚱ Sapphire:* ${Bsapphire}
               ...
               if (global.db.data.users[m.sender].naga == 1) return conn.reply(m.chat, 'Kamu sudah memiliki pet ini', m)
                ...
                case 'foodpet':
                    ...
                    case 'iron':
                        ...
                        break
                    case 'arloji':
                           if (global.db.data.users[m.sender].money >= Barloji * count) {
                               global.db.data.users[m.sender].arlok += count * 1
                               global.db.data.users[m.sender].money -= Barloji * count
                               conn.reply(m.chat, `✔️ Sukses Membeli ${count} Arloji ⛓️ Dengan Harga ${Barloji * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                    case 'common':
                    ...
                    case 'mythic':
                     ...
                     break
                    case 'voucher':
                            if (global.db.data.users[m.sender].money >= Bvoucher * count) {
                                global.db.data.users[m.sender].voucher += count * 1
                                global.db.data.users[m.sender].money -= Bvoucher * count
                                conn.reply(m.chat, `✔️ Sukses Membeli ${count} voucher 🎟 Dengan Harga ${Bvoucher * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${count} Voucher 🎟 Dengan Harga ${Bvoucher* count} Money\n\n📍 Buka Voucher Dengan Ketik:*${usedPrefix}open voucher*`, m)
                        break
                    case 'legendary':
                    ...
                    case 'armor':
                     ...
                     case 'fishingrod':
                            ...
                            if (global.db.data.users[m.sender].money > pancing) {
                                global.db.data.users[m.sender].pancing += 1
                                global.db.data.users[m.sender].money -= pancing * 1
            ...
            case 'sell': 
                switch (_type) {
                    ...
                    case 'sapphire':
                        ...
                        break
                    case 'voucher':
                        if (global.db.data.users[m.sender].voucher >= count * 1) {
                            global.db.data.users[m.sender].money += Svoucher * count
                            global.db.data.users[m.sender].voucher -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${count} voucher 🎟 Dengan Harga ${Svoucher * count} money 🎟`.trim(), m)
                        } else conn.reply(m.chat, `🎟 voucher Kamu Tidak Cukup`.trim(), m)
                        break
                    case 'arloji':
            ...
            case 'upgrade': 
                switch (_type) {
                	case 'armor':
                        ...
                        break
                        case 'fishingrod':
                            if (global.db.data.users[m.sender].pancing == 4) return conn.reply(m.chat, 'Pancingan mu udah *Level Max*', m)
                            if (global.db.data.users[m.sender].pancing == 0) return conn.reply(m.chat, 'Kamu belum mempunyai Pancingan', m)
                ...
                case 'superior':
                  ...
                  case 'voucher':
                        if (global.db.data.users[m.sender].money >= Bvoucher * count) {
                            global.db.data.users[m.sender].voucher += count * 1
                            global.db.data.users[m.sender].money -= Bvoucher * count
                            conn.reply(m.chat, `Sukses Membeli ${count} voucher Dengan Harga ${Bvoucher * count} Money`, m)
                        } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${count} voucher Dengan Harga ${Bvoucher * count} Money \n\nBuka voucher Dengan Ketik: *${usedPrefix}open voucher*`, m)
