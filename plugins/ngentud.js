...
`
hslngentud = `*—[ Hasil Dari ${command} ${name.vnmae || name.notify || name.name || ('+' + name.jid.split`@`[0])} ]—*
...
setTimeout(() => {
                     conn.sendBut(m.chat, `${hslngentud}`, 'Tante tante anaknya maen fitur bokep tante ciduk tante ciduk', 'Dompet', `.dompet`, m)
                     }, 35000) 
                     ...
                     setTimeout(() => {
                     conn.sendBut(m.chat, `${dimasganteng3}`, 'Tante tante anaknya maen fitur bokep tante ciduk tante ciduk', 'Yamete Onichan 😳', `.haram`, m)
                     }, 20000) 
